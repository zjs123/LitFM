...
class QloraTrainer_physics:
    ...
    def train(self):
        ...
        train_data = self._process_data() #self._process_vicuna_data()
        ...
        try:
            ...
            pass
        model_save_path = f"{self.config['model_output_dir']}/{self.config['model_name']}_adapter_physics_title_abs"
    ...
    def _process_data(self):
        ...
        for edge in test_data:
            all_test_nodes.add(edge[0])
            all_test_nodes.add(edge[1])
        print(len(all_test_nodes))
    ...
    def _generate_abstrat_completion_prompt(self, data_point: dict, eos_token: str, instruct: bool = False):
        ...
        Q = Q + "Please complete the abstract of paper A : " + '\n'
...
#CUDA_VISIBLE_DEVICES=0  python train.py configs/vicuna_7b_qlora_uncensored.yaml physics