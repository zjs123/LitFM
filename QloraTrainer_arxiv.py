...
class QloraTrainer_arxiv:
    ...
    def train(self):
        ...
        try:
            ...
            pass
        model_save_path = f"{self.config['model_output_dir']}/{self.config['model_name']}_adapter_arxiv"
    ...
    def _process_data(self):
        ...
        with open("/home/jz875/project/Citation_Graph/title_abstracts_cs_it.json",'r', encoding='UTF-8') as f:
...
#CUDA_VISIBLE_DEVICES=0  python train.py configs/vicuna_7b_qlora_uncensored.yaml arxiv